...
<head>
  ...
  <link rel="stylesheet" href="${contextPath}/resources/css/local/weChat/login.css">
  ...
  <script type="text/javascript" src="${contextPath}/resources/js/local/weChat/login.js?2017022001"></script>
</head>
<body>
...
<div class="content">
  <div class="line">
    ...
    <input type="tel" autocomplete="off" id="mobile" placeholder="请输入11位手机号码">
  </div>
  <div class="line">
    <div class="line_img_div">
      <img class="line_img" src="${contextPath}/resources/images/weChat/mem/icon_login_password_h.png">
    </div>
    <input type="password" autocomplete="off" id="pwd" placeholder="请输入密码">
  </div>
  <div class="submit_button" onclick="login(this);">登录</div>
  <div class="bottom_div">
    <a class="login_a" href="javascript: forwardRegister();">注册</a>
    <a class="forget_pwd" href="javascript: forwardForgetpwd();">忘记密码</a>
  </div>
</div>
</body>
</html>

...
<head>
  ...
  <link rel="stylesheet" href="${contextPath}/resources/css/local/weChat/order_list.css?2017070701">
  ...
  <script type="text/javascript" src="${contextPath}/resources/js/local/weChat/order_list.js?2017071402"></script>
</head>
<body>
